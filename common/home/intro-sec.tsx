...
const IntroSection = () => {
  return (
    <div className="flex flex-col items-center justify-center relative z-20  py-10 ">
      <p className="text-white uppercase text-[18px]  pb-[20px] z-50">
      ...
      <div className="absolute bottom-[-60px] left-[-80px] z-0">
        <Image
