  ...
  return (
    <div>
      <div className="absolute z-10 opacity-60">
        <iframe src="/assets/mp4/file.mp4" width="1000" height="600" />
      </div>
      <div className="flex items-center justify-between py-4 relative lg:px-16 px-12">
        <div className="absolute bg-[#0A2340] w-[240px] h-[240px] lg:w-[360px] lg:h-[360px] rounded-full -left-28 lg:-left-40 -z-0">
        </div>
